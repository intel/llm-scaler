...
COMFYUI_COMMIT="${COMFYUI_COMMIT:-40c4fcdf513a4523e39d54a9d391908af8df8171}"
COMFYUI_VERSION="${COMFYUI_VERSION:-0.35.0}"
COMFYUI_FRONTEND_VERSION="${COMFYUI_FRONTEND_VERSION:-1.51.10}"
COMFYUI_WORKFLOW_TEMPLATES_VERSION="${COMFYUI_WORKFLOW_TEMPLATES_VERSION:-0.11.57}"
...
KITCHEN_COMMIT="${COMFY_KITCHEN_COMMIT:-44bf8628a577eb70e23485937f28a1f2ecdd9811}"
KITCHEN_VERSION="${COMFY_KITCHEN_VERSION:-0.2.33}"
AIMDO_REPOSITORY="${COMFY_AIMDO_REPOSITORY:-https://github.com/xiangyuT/comfy-aimdo-xpu.git}"
AIMDO_COMMIT="${COMFY_AIMDO_COMMIT:-a85cefe47c0718540b0bbf37249618350d66a40e}"
AIMDO_VERSION="${COMFY_AIMDO_VERSION:-0.5.3}"
...
SOL_ATTN_REPOSITORY="${COMFY_SOL_ATTN_REPOSITORY:-https://github.com/xiangyuT/ComfyUI-SolAttn_xpu.git}"
SOL_ATTN_COMMIT="${COMFY_SOL_ATTN_COMMIT:-5f1c4aac3ca32a00b0b4c15ddbb7cb53fa43344d}"
...
DOCKER_ARGS=(
    ...
    --build-arg "COMFY_SOL_ATTN_REPOSITORY=${SOL_ATTN_REPOSITORY}"
    --build-arg "COMFY_SOL_ATTN_COMMIT=${SOL_ATTN_COMMIT}"
