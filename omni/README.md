...
| **Video Generation** | HunyuanVideo 1.5 8.3B | Image-to-Video | `Hunyuan_1_5_I2V_Raylight.json` |
...
**Available Workflows:**
- **Hunyuan_1_5_I2V_Raylight.json**: 8.3B Image-to-Video multi-XPU support with [raylight](https://github.com/komikndr/raylight)
