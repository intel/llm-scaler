...
Output:
- %OUTPUT_DIR%\omni_xpu_kernel-0.1.0b8-cp312-cp312-win_amd64.whl
...
```
"%EMBED_PYTHON_DIR%\python.exe" -m pip install --force-reinstall --no-deps "%OUTPUT_DIR%\omni_xpu_kernel-0.1.0b8-cp312-cp312-win_amd64.whl"
```
